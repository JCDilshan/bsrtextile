        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12 text-danger p-5">
                    ...
                    <form class="pb-5" id="newCustomer" enctype="multipart/form-data" method="POST" action="../controller/login_controller.php?type=sendResetLink">
...
<!-- content end -->
<script>
    document.title = "BOSARA TEXTILE | Password Reset";
</script>
<?php
