...
$getCustomer = $cus_obj->giveCustomer_ByCustomerID_FromCustomer($customerId);
$cusInfo = $getCustomer->fetch_assoc();
        ...
        <div class="row mt-3">
            <div class="col-sm-10 mx-auto">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <h3 class="text-success text-center"><?php echo $response; ?></h3>
        ...
        <div class="row mt-3">
            <div class="col-sm-10 mx-auto">
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <h3 class="text-danger text-center"><?php echo $response; ?></h3>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form id="editCustomer" enctype="multipart/form-data" method="post" action="../controller/customer_controller.php?type=editCustomer">
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-4 text-muted">
                                <input type="text" name="fname" id="fname" class="form-control" value="<?php echo $cusInfo["customer_fname"]; ?>" required>
                            </div>
                            <div class="col-sm-2 text-muted">
                                <label for="" class="control-label">Last Name <i class="text-danger">*</i></label>
                            </div>
                            <div class="col-sm-4 text-muted">
                                <input type="text" name="lname" id="lname" class="form-control" value="<?php echo $cusInfo["customer_lname"]; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-4 text-muted">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="contact" id="contact" class="form-control" value="<?php echo substr($cusInfo["customer_cno"], 1); ?>" required>
                                </div>
                            </div>
                            <div class="col-sm-2 text-muted">
                            ...
                            <div class="col-sm-4 text-muted ">
                                <input type="text" name="nic" id="nic" class="form-control" value="<?php echo $cusInfo["customer_nic"]; ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-4 text-muted">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="customRadio1" name="gender" class="custom-control-input" value="M" <?php if ($cusInfo["customer_gender"] == "M") { ?> checked <?php } ?>>
                                    <label class="custom-control-label" for="customRadio1">Male</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="customRadio2" name="gender" class="custom-control-input" value="F" <?php if ($cusInfo["customer_gender"] == "F") { ?> checked <?php } ?>>
                            ...
                            <div class="col-sm-4 text-muted">
                                <input type="number" name="postalcode" id="postalcode" class="form-control" minlength="5" maxlength="5" value="<?php echo $cusInfo["customer_postal_id"]; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-4 text-muted">
                                <input type="text" name="addr1" id="addr1" class="form-control " placeholder="Street Address 01" value="<?php echo $cusInfo["customer_addr1"]; ?>" required>
                                <br>
                                <input type="text" name="addr2" id="addr2" class="form-control " placeholder="Street Address 02" value="<?php echo $cusInfo["customer_addr2"]; ?>" required>
                                <br>
                                <input type="text" name="addr3" id="addr3" class="form-control" placeholder="City" value="<?php echo $cusInfo["customer_addr3"]; ?>" required>
                            </div>
                            <div class="col-sm-2 text-muted">
                            ...
                            <div class="col-sm-4 text-muted">
                                ...
                                <br><br>
                                <img id="prev_img" src="../image/users/<?php echo $cusInfo["customer_img"]; ?>" width="100px" height="90px">
                            </div>
                        </div>

                        <div class="row mt-3">
                            <div class="col-sm-4 text-muted ml-auto">
