...
$cusInfo = $customer_obj->giveCustomer_ByCustomerID_FromCustomer($customerId);
$cusRow = $cusInfo->fetch_assoc();

$loginInfo = $customer_obj->giveCustomer_ByCustomerID_FromLogin($customerId);
$loginRow = $loginInfo->fetch_assoc();
    ...
    <div class="row justify-content-center p-3">
        <div class="col-sm-12 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3 scard">
                ...
                <form id="paymentForm" method="POST" action="../controller/order_controller.php?type=addOrder">
                            ...
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 text-muted">
                                        <input type="text" name="fname" id="fname" class="form-control" value="<?php echo $cusRow['customer_fname']; ?>" required>
                                    ...
                                    <div class="col-sm-4 text-muted">
                                        <input type="text" name="lname" id="lname" class="form-control" value="<?php echo $cusRow['customer_lname']; ?>" required>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-sm-4 text-muted">
                                        <input type="email" name="email" id="email" class="form-control" value="<?php echo $loginRow['login_email']; ?>" required>
                                    ...
                                    <div class="col-sm-4 text-muted">
                                        <input type="text" name="contact" id="contat" class="form-control" value="<?php echo $cusRow['customer_cno']; ?>" required>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-sm-4 text-muted">
                                        <input type="text" name="postalcode" id="postalcode" class="form-control" value="<?php echo $cusRow['customer_postal_id']; ?>" maxlength="5" required>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-sm-3 text-muted pr-0">
                                        <input type="text" name="addr1" id="addr1" class="form-control " placeholder="Street Address 01" value="<?php echo $cusRow['customer_addr1']; ?>" required>
                                        <div class="float-left" id="addr1alert"></div>
                                    </div>
                                    <div class="col-sm-3 text-muted pr-0 mt-2 mt-sm-0">
                                        <input type="text" name="addr2" id="addr2" class="form-control " placeholder="Street Address 02" value="<?php echo $cusRow['customer_addr2']; ?>" required>
                                        <div class="float-left" id="addr2alert"></div>
                                    </div>
                                    <div class="col-sm-3 text-muted pr-0 mt-2 mt-sm-0">
                                        <input type="text" name="addr3" id="addr3" class="form-control" placeholder="City" value="<?php echo $cusRow['customer_addr3']; ?>" required>
...
<script>
    document.title = "BOSARA TEXTILE | Checkout";
</script>
