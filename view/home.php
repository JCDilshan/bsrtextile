...
<div class="container-fluid" id="newIn">
    ...
    <div class="row">
        ...
        $newMaleProducts = $product_obj->giveNew_MaleProducts();

        while ($maleRow = $newMaleProducts->fetch_assoc()) {

            $productId = $maleRow["product_id"];
            $productImg = $product_obj->giveAllImages_ByProductId($productId);
    ...
    <div class="row">
        ...
        $newFemaleProducts = $product_obj->giveNew_FemaleProducts();

        while ($maleRow = $newFemaleProducts->fetch_assoc()) {
